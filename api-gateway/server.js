...
// Forward requests to microservices
app.use('/auth', createProxyWithLogging(Config.auth));
app.use('/user', createProxyWithLogging(Config.user));
app.use('/tournament', createProxyWithLogging(Config.tournament));
app.use('/product', createProxyWithLogging(Config.product));
app.use('/scoring', createProxyWithLogging(Config.scoring));
app.use('/team', createProxyWithLogging(Config.team));
app.use('/venue', createProxyWithLogging(Config.venue));
app.use('/notifications', createProxyWithLogging(Config.notification));
